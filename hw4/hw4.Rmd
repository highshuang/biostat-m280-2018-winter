...
* Label 1 indicates the sudden decrease happened in 2001-09-11, when 911 Attacks happened. People traveled by air less often, due to the fear toward terrorists. Label 2 and label 3 corresponding to Independence Day and Thanksgiving holidays. The demand for air travel mighte increase for the spare time during holidays. Label 4 indicates the sudden decrease around 2008-01-01. During that time, the new airplanes were created with larger capacity, resulted in the less flights needed. Label 5 indicates the sudden increase around 2001-09-11, when Los Angeles finished city constructions. The improvement of airport construction would results in larger capcity of flights.

    (b). Visualize and explain seasonal effects.
```{r}
    LAX.traffic.season <- flights_tbl %>% 
      select(year, month, dayofmonth, origin, dest) %>%
