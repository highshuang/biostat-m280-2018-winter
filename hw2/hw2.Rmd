...
ggplot(diamonds) +
  geom_point(aes(x = y, y = price), color = "black") +
...
ggplot(diamonds) +
  geom_point(aes(x = z, y = price), color = "black") +
...
ggplot(diamonds) +
  geom_point(aes(x = depth, y = price), color = "black") +
...
ggplot(diamonds) +
  geom_point(aes(x = table, y = price), color = "black") +
